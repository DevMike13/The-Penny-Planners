    ...
    <div className='bg-white w-full h-auto flex justify-center items-center flex-col'>
      ...
      <div className='p-6 w-full md:max-w-[780px] m-auto pt-10'>
        ...
        <p className='text-center'>
            <b>ThePennyPlanners.com</b> is a website where we help users find the best deals online. All of the offers and promotions shown on the site are custom curated for selected users only. To contact us, please email us at <a href="mailto:support@thepennyplanners.com" className='text-blue-500 underline'>support@thepennyplanners.com</a>
        </p><br />
