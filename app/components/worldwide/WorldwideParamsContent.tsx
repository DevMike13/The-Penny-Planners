...
import { products, otherOffers } from "@/static/worldwide-data";
import React from "react";

const WorldwideParamsContent = () => {
  ...
  return (
    <>
      <div className="w-[90%] md:w-full md:max-w-[780px] m-auto mt-10">
        <p className="text-lg">
            Looking to find the best world-wide product deals without breaking the bank? We have done the hard work for you by hunting down these absolute best online deals right now! Our team of shopping experts has uncovered these incredible products at their
...
export default WorldwideParamsContent